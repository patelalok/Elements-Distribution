...
//     }),
//     Shopify.optionsMap = {},
//     Shopify.updateOptionsInSelector = function(i) {
//         switch (i) {
//         case 0:
//             var t = "root"
...
//                 i.options.length > 1) {
//                     var o = a.option1;
//                     Shopify.optionsMap[o] = Shopify.optionsMap[o] || [],
//                     Shopify.optionsMap[o].push(a.option2),
//                     Shopify.optionsMap[o] = Shopify.uniq(Shopify.optionsMap[o])
//                 }
//                 if (3 === i.options.length) {
//                     var o = a.option1 + " / " + a.option2;
//                     Shopify.optionsMap[o] = Shopify.optionsMap[o] || [],
//                     Shopify.optionsMap[o].push(a.option3),
//                     Shopify.optionsMap[o] = Shopify.uniq(Shopify.optionsMap[o])
//                 }
//             }
//         }
//         Shopify.updateOptionsInSelector(0),
//         i.options.length > 1 && Shopify.updateOptionsInSelector(1),
//         3 === i.options.length && Shopify.updateOptionsInSelector(2),
//         e(".single-option-selector:eq(0)").change(function() {
//             return Shopify.updateOptionsInSelector(1),
//             3 === i.options.length && Shopify.updateOptionsInSelector(2),
//             !0
//         }),
//         e(".single-option-selector:eq(1)").change(function() {
//             return 3 === i.options.length && Shopify.updateOptionsInSelector(2),
//             !0
//         })
//     }
//     ),
...
//         27 == i.keyCode && (t.closeQuickViewPopup(),
//         t.closeDropdownCart(),
//         t.closeDropdownSearch(),
...
//                 e(this).hasClass("active") || (delete Shopify.queryParams.q,
...
//                     Shopify.queryParams.view = e(this).hasClass("list") ? "list" + a : a,
//                     t.sidebarAjaxClick(),
...
//                     Shopify.queryParams.view = "list" == o ? "list" + a : a,
//                     t.sidebarAjaxClick(),
//                     e(".filter-show > button span").text(a),
...
//                 i.hasClass("click") ? i.removeClass("click") : i.addClass("click"),
...
//                     t.sidebarAjaxClick();
//                     var a = e(this).text();
//                     e(".filter-sortby > button span").text(a),
...
//             if (i && i[1] && e(".sidebar-links a[href='" + i[0] + "']").addClass("active"),
//             Shopify.queryParams.view) {
//                 e(".view-mode .active").removeClass("active");
//                 var a = Shopify.queryParams.view;
//                 a.indexOf("list") >= 0 ? (e(".view-mode .list").addClass("active"),
//                 a = a.replace("list", "")) : e(".view-mode .grid").addClass("active"),
//                 e(".filter-show > button span").text(a),
//                 e(".filter-show li.active").removeClass("active"),
//                 e(".filter-show a[href='" + a + "']").parent().addClass("active")
//             }
//             t.initSortby()
//         },
//         initSortby: function() {
...
//                 e(".filter-sortby li.active").removeClass("active"),
//                 e(".filter-sortby a[href='" + i + "']").parent().addClass("active")
//             }
//         },
...
//             0 == o.length && (o = e(i).find(".col-main .product-list")),
//             o.length > 0 && o.hasClass("products-grid") && window.product_image_resize && o.find("img").fakecrop({
//                 fill: window.images_size.is_crop,
//                 widthSelector: ".products-grid .grid-item .product-image",
//                 ratioWrapper: window.images_size
//             }),
//             a.replaceWith(o),
//             t.checkNeedToConvertCurrency() && Currency.convertAll(window.shop_currency, jQuery("#currencies").val(), ".col-main span.money", "money_format"),
...
//             return n.find("h2").text() != r.find("h2").text() && (n.find("h2").replaceWith(r.find("h2")),
//             n.find(".rte").length ? r.find(".rte").length ? n.find(".rte").replaceWith(r.find(".rte")) : n.find(".rte").hide() : r.find(".rte").length && n.find("h2").after(r.find(".rte"))),
...
//             $(".spr-badge").length > 0 ? (window.SPR.registerCallbacks(),
...
//                     e(".ajax-error-message").text(e.parseJSON(i.responseText).description),
...
//                 for (var i, e = 0, t = location.search.substr(1).split("&"); e < t.length; e++)
//                     i = t[e].split("="),
//                     i.length > 1 && (Shopify.queryParams[decodeURIComponent(i[0])] = decodeURIComponent(i[1]))
//         },
...
//                 i.preventDefault(),
//                 e(".sidebar").is(":hidden") ? (e(".sidebar").fadeIn(800),
//                 e("body,html").animate({
//                     scrollTop: 400
//                 }, 600),
//                 e("#displayTextLeft").toggleClass("hidden-arrow-left"),
//                 e("#displayTextLeft").attr("title", "hide-sidebar"),
//                 e("#displayTextLeft").html("<span>Hide Sidebar</span>")) : (e(".sidebar").fadeOut(800),
//                 e("#displayTextLeft").removeClass("hidden-arrow-left"),
//                 e("#displayTextLeft").attr("title", "show-sidebar"),
//                 e("#displayTextLeft").html("<span>Show Sidebar</span>"))
//             })
//         },
//         initSidebar: function() {
//             e(".collection-sidebar").length > 0 && (t.sidebarParams(),
//             t.initSortby(),
//             t.sidebarMapEvents(),
//             t.sidebarMapPaging(),
//             t.sidebarInitToggle(),
...
//             e(".menu-block").is(":visible") ? (e(".mobile-menu-device-container ul.gf-menu li.dropdown").each(function() {
//                 0 == e(this).find("> p.toogleClick").length && e(this).prepend('<p class="toogleClick">+</p>')
//             }),
//             0 == e(".menu-block").children().hasClass("mobile-device-menu") && e(".menu-block").children().addClass("mobile-device-menu"),
//             0 == e(".mobile-menu-device-container").find("ul.gf-menu").size() && (e(".mobile-menu-device-container").append(e(".nav-bar .container").html()),
//             e(".mobile-menu-device-container .site-nav").addClass("gf-menu"),
//             e(".mobile-menu-device-container .site-nav").removeClass("nav")),
//             e("p.toogleClick").click(function() {
//                 e(this).hasClass("mobile-toggle-open") ? (e(this).next().next().hide(),
//                 e(this).removeClass("mobile-toggle-open")) : (e(this).next().next().show(),
//                 e(this).addClass("mobile-toggle-open"))
//             }),
//             e("p.toogleClick").show(),
//             e("div.gf-menu-toggle").hide(),
//             e(".nav-bar .container").hide(),
//             0 == e("ul.gf-menu").hasClass("clicked") && (e(".gf-menu").hide(),
//             e(".gf-menu li.dropdown ul.site-nav-dropdown").hide()),
//             e(".col-1 .inner ul.dropdown").parent().each(function() {
//                 0 == e(this).find("> p.toogleClick").length && e(this).prepend('<p class="toogleClick">+</p>')
//             }),
//             e(".mobile-menu span.icon-dropdown").remove(),
...
//                 e(this).addClass("mobile-toggle-open"))
//             }),
//             e(".header-panel-bottom ul.customer-links").prependTo(e(".customer-area .dropdown-menu"))) : (e(".nav-bar .container").show(),
//             e(".gf-menu").hide(),
//             e(".customer-area ul.customer-links").appendTo(e(".header-panel-bottom")).after(e(".top-header"))),
//             0 == e(".menu-block").children().hasClass("mobile-device-menu") && e(".menu-block").children().addClass("resized")
//         },
...
//                     success: function() {
//                         t.hideLoading(),
//                         a.html('<a class="wishlist" href="/pages/wish-list" title="Go to wishlist"><span class="icon"></span><span>Go to wishlist</span></a>');
...
//                 o.find("input[name='contact[tags]']").val("x" + a),
//                 e.ajax({
//                     type: "POST",
//                     url: "/contact",
//                     data: o.serialize(),
...
//                 i.preventDefault(),
//                 e(this).hasClass("disabled") || t.doInfiniteScrolling()
//             })
//         },
//         doInfiniteScrolling: function() {
//             var i = $(".block-row .products-grid");
//             if (i.length || (i = $(".block-row .product-list")),
//             i) {
//                 var e = $(".infinite-scrolling a").first();
//                 $.ajax({
//                     type: "GET",
//                     url: e.attr("href"),
//                     beforeSend: function() {
...
//                     success: function(a) {
//                         t.hideLoading();
//                         var o = $(a).find(".block-row .products-grid");
//                         return o.length || (o = $(a).find(".block-row .product-list")),
//                         o.length && (o.hasClass("products-grid") && window.product_image_resize && o.children().find("img").fakecrop({
//                             fill: window.images_size.is_crop,
//                             widthSelector: ".products-grid .grid-item .product-image",
//                             ratioWrapper: window.images_size
//                         }),
...
//                         t.initAddToCart(),
//                         t.initWishlist(),
//                         $(a).find(".infinite-scrolling").length > 0 ? e.attr("href", $(a).find(".infinite-scrolling a").attr("href")) : (e.hide(),
//                         e.next().show()),
...
//                         t.hideLoading(),
//                         $(".loading-modal").hide(),
//                         $(".ajax-error-message").text($.parseJSON(i.responseText).description),
//                         t.showModal(".ajax-error-modal")
//                     },
//                     dataType: "html"
//                 })
...
//                 e(".collection-sharing-panel").is(":visible") ? (e(".collection-sharing-btn").addClass("btn-hover"),
//                 e(".collection-filter-panel").hide(),
//                 e(".collection-filter-btn").removeClass("btn-hover")) : e(".collection-sharing-btn").removeClass("btn-hover")
//             }),
//             e(".collection-filter-btn").length > 0 && (e(".collection-filter-btn").click(function() {
//                 e(".collection-filter-panel").toggle(),
//                 e(".collection-filter-panel").is(":visible") ? (e(".collection-filter-btn").addClass("btn-hover"),
//                 e(".collection-sharing-panel").hide(),
//                 e(".collection-sharing-btn").removeClass("btn-hover")) : e(".collection-filter-btn").removeClass("btn-hover")
//             }),
...
//         //     e("#dropdown-cart .mini-products-list").children().length > 0 ? (e("#dropdown-cart .no-items").hide(),
//         //     e("#dropdown-cart .has-items").show()) : (e("#dropdown-cart .has-items").hide(),
...
//                 a = a.match(/\d+/g),
//                 Shopify.removeItem(a, function(i) {
...
//                 success: function() {
//                     t.hideLoading(),
//                     e(".ajax-success-modal").find(".ajax-product-title").text(o),
//                     e(".ajax-success-modal").find(".ajax-product-image").attr("src", n),
...
//                     e(".quick-view").html(a);
//                     var o = e(".quick-view");
//                     if (o.find(".product-title a").text(i.title),
//                     o.find(".product-title a").attr("href", i.url),
//                     o.find(".product-vendor span").length > 0 && o.find(".product-vendor span").text(i.vendor),
//                     o.find(".product-type span").length > 0 && o.find(".product-type span").text(i.type),
//                     o.find(".product-inventory span").length > 0) {
...
//                         r && r.length > 0 && (o.find(".countdown").show(),
//                         o.find(".quickview-clock").countdown(r[1], function(i) {
...
//                         o.find(".product-description").text(s)
//                     } else
//                         o.find(".product-description").remove();
//                     o.find(".price").html(Shopify.formatMoney(i.price, window.money_format)),
//                     o.find(".product-item").attr("id", "product-" + i.id),
//                     o.find(".variants").attr("id", "product-actions-" + i.id),
//                     o.find(".variants select").attr("id", "product-select-" + i.id),
//                     i.compare_at_price > i.price ? (o.find(".compare-price").html(Shopify.formatMoney(i.compare_at_price_max, window.money_format)).show(),
//                     o.find(".price").addClass("on-sale")) : (o.find(".compare-price").html(""),
//                     o.find(".price").removeClass("on-sale")),
//                     i.available ? (o.find(".total-price span").html(Shopify.formatMoney(i.price, window.money_format)),
//                     window.use_color_swatch ? t.createQuickViewVariantsSwatch(i, o) : t.createQuickViewVariants(i, o)) : (o.find("select, input, .total-price, .dec, .inc, .variants label").remove(),
//                     o.find(".add-to-cart-btn").text("Unavailable").addClass("disabled").attr("disabled", "disabled")),
//                     o.find(".button").on("click", function() {
//                         var i = o.find(".quantity").val()
//                           , a = 1;
//                         "+" == e(this).text() ? a = parseInt(i) + 1 : i > 1 && (a = parseInt(i) - 1),
//                         o.find(".quantity").val(a),
//                         o.find(".total-price").length > 0 && t.updatePricingQuickview()
//                     }),
//                     window.show_multiple_currencies && Currency.convertAll(window.shop_currency, jQuery("#currencies").val(), "span.money", "money_format"),
//                     t.loadQuickViewSlider(i, o),
//                     t.initQuickviewAddToCart(),
//                     e(".quick-view").fadeIn(500),
//                     e(".quick-view .total-price").length > 0 && e(".quick-view input[name=quantity]").on("change", t.updatePricingQuickview)
//                 }),
//                 !1
//             }),
//             e(".quick-view .overlay, .close-window").live("click", function() {
//                 return t.closeQuickViewPopup(),
//                 !1
//             })
//         },
...
//             if (e("#cartCount").text(i.item_count),
//             e("#dropdown-cart .summary .price").html(Shopify.formatMoney(i.total_price, window.money_format)),
//             e("#dropdown-cart .mini-products-list").html(""),
//             i.item_count > 0) {
//                 for (var o = 0; o < i.items.length; o++) {
//                     var n = a;
//                     n = n.replace(/\{ID\}/g, i.items[o].id),
//                     n = n.replace(/\{URL\}/g, i.items[o].url),
//                     n = n.replace(/\{TITLE\}/g, i.items[o].title),
//                     n = n.replace(/\{QUANTITY\}/g, i.items[o].quantity),
//                     n = n.replace(/\{IMAGE\}/g, Shopify.resizeImage(i.items[o].image, "small")),
//                     n = n.replace(/\{PRICE\}/g, Shopify.formatMoney(i.items[o].price, window.money_format)),
//                     e("#dropdown-cart .mini-products-list").append(n)
//                 }
//                 e("#dropdown-cart .btn-remove").click(function(i) {
//                     i.preventDefault();
//                     var a = e(this).parents(".item").attr("id");
...
//             if (o.find(".quickview-featured-image").append('<a href="' + a.url + '"><img src="' + n + '" title="' + a.title + '"/><div style="height: 100%; width: 100%; top:0; left:0 z-index: 2000; position: absolute; display: none; background: url(' + window.loading_url + ') 50% 50% no-repeat;"></div></a>'),
//             a.images.length > 1) {
//                 var r = o.find(".more-view-wrapper ul")
//                   , s = 0;
//                 for (i in a.images)
//                     if (s < a.images.length) {
//                         var l = Shopify.resizeImage(a.images[i], "grande")
//                           , c = Shopify.resizeImage(a.images[i], "compact")
//                           , d = '<li><a href="javascript:void(0)" data-image="' + l + '"><img src="' + c + '"  /></a></li>';
//                         r.append(d),
//                         s += 1
//                     }
...
//                     i.attr("src") != e(this).attr("data-image") && (i.attr("src", e(this).attr("data-image")),
//                     t.show(),
//                     i.load(function() {
//                         t.hide(),
//                         e(this).unbind("load"),
...
//             } else
//                 o.find(".quickview-more-views").remove(),
//                 o.find(".quickview-more-view-wrapper-jcarousel").remove()
//         },
...
//                     l += '<div class="swatch clearfix" data-option-index="' + a + '">',
//                     l += '<div class="header">' + i.options[a].name + "</div>";
//                     var c = !1;
...
//                           , h = "swatch-" + a + "-" + f;
//                         d.indexOf(u) < 0 && (l += '<div data-value="' + u + '" class="swatch-element ' + (c ? "color" : "") + f + (o.available ? " available " : " soldout ") + '">',
//                         c && (l += '<div class="tooltip">' + u + "</div>"),
//                         l += '<input id="' + h + '" type="radio" name="option-' + a + '" value="' + u + '" ' + (0 == p ? " checked " : "") + (o.available ? "" : " disabled") + " />",
//                         l += c ? '<label for="' + h + '" style="background-color: ' + f + "; background-image: url(" + r + f + '.png)"><img class="crossed-out" src="' + s + 'soldout.png" /></label>' : '<label for="' + h + '">' + u + '<img class="crossed-out" src="' + s + 'soldout.png" /></label>',
//                         l += "</div>",
//                         o.available && e('.quick-view .swatch[data-option-index="' + a + '"] .' + f).removeClass("soldout").addClass("available").find(":radio").removeAttr("disabled"),
//                         d.push(u))
//                     }
//                     l += "</div>"
//                 }
//                 t.find("form.variants > select").after(l),
//                 t.find(".swatch :radio").change(function() {
//                     var i = e(this).closest(".swatch").attr("data-option-index")
//                       , t = e(this).val();
//                     e(this).closest("form").find(".single-option-selector").eq(i).val(t).trigger("change")
//                 }),
//                 i.available && (Shopify.optionsMap = {},
//                 Shopify.linkOptionSelectors(i))
//             } else {
...
//                 for (var t = 0; t < i.variants.length; t++) {
//                     var a = i.variants[t]
//                       , o = '<option value="' + a.id + '">' + a.title + "</option>";
//                     e.find("form.variants > select").append(o)
//                 }
...
//                 }),
//                 1 == i.options.length) {
//                     $(".selector-wrapper:eq(0)").prepend("<label>" + i.options[0].name + "</label>");
//                     for (var n = i.variants, r = 0; r < n.length; r++) {
//                         var s = n[r];
//                         s.available || jQuery(".single-option-selector option").filter(function() {
...
//                 var l = '<input type="hidden" name="id" value="' + i.variants[0].id + '">';
//                 e.find("form.variants").append(l)
//             }
//         },
